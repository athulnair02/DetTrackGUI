...
function [data] = loadConditionData3D_m(varargin)

ip = inputParser;
ip.CaseSensitive = false;
ip.KeepUnmatched = true;
ip.FunctionName = 'loadConditionData3D_m';
...
data = loadConditionData(ip.Results.condDir, ip.Results.chNames, ip.Results.markers);
nd = numel(data);
